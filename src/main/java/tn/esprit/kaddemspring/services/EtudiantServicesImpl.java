...
public class EtudiantServicesImpl implements EtudiantServices {
    ...
    public Set<Etudiant> getEtudiantByDepAndUni(Departement Departement, Université Universite){
        List<Departement> departementslist = (List<Departement>) Universite.getDepartementSet();
